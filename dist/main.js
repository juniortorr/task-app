...
/***/ "./src/views/partials/today-task-filter.handlebars":
/*!*********************************************************!*\
  !*** ./src/views/partials/today-task-filter.handlebars ***!
  \*********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"todayContainer\">\r\n    <div class=\"todayCard\">\r\n\r\n    <ul class=\"taskList\">\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"todayTaskList") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":8},"end":{"line":11,"column":17}}})) != null ? stack1 : "")
    + "    </ul>\r\n\r\n\r\n</div>\r\n</div>\r\n";
},"useData":true});
...
/* harmony import */ var _views_partials_today_task_filter_handlebars__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/partials/today-task-filter.handlebars */ "./src/views/partials/today-task-filter.handlebars");
/* harmony import */ var _views_partials_today_task_filter_handlebars__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_views_partials_today_task_filter_handlebars__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _images_card_options_png__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./images/card-options.png */ "./src/images/card-options.png");
/* harmony import */ var _components_dateCheck__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/dateCheck */ "./src/components/dateCheck.js");
...
const domStuff = (function(){
    ...
    function newProjPopup() {
        ...
        form.addEventListener('submit', (e) => {;(0,_app__WEBPACK_IMPORTED_MODULE_6__.initiateNewProj)(input.value, select.value), e.preventDefault()})
    }
    ...
    function newTaskPopup (task, project) {
        ...
        addNewTaskBtn.addEventListener('click', (e) => { (0,_components_data__WEBPACK_IMPORTED_MODULE_7__.updateTodoData)(task), updateTodoUI(task.list, taskForm) })
    ...
    function updateProjectListUI() {
        cardContainer.innerHTML = _views_partials_proj_card_handlebars__WEBPACK_IMPORTED_MODULE_1___default()({projectList: _components_data__WEBPACK_IMPORTED_MODULE_7__.projectList, cardOptionsIcon: _images_card_options_png__WEBPACK_IMPORTED_MODULE_8__})
        ...
        projTitleBox.forEach((box) => {
            ...
            cardOptions.src = _images_card_options_png__WEBPACK_IMPORTED_MODULE_8__
            box.append(cardOptions)
            cardOptions.addEventListener('click', () => {projectOptionsPopup(box)})
        })
        newTaskBtn.forEach((btn) => {
            btn.addEventListener('click', () => {;(0,_app__WEBPACK_IMPORTED_MODULE_6__.initiateNewTask)(btn)})
        })
    }   

    const todayTasksUI = (todayTaskList) => {
        cardContainer.innerHTML = _views_partials_today_task_filter_handlebars__WEBPACK_IMPORTED_MODULE_5___default()({todayTaskList})
    }
    ...
    function projectOptionsPopup(titleDiv) {
        ...
        ;(0,_app__WEBPACK_IMPORTED_MODULE_6__.callDeleteProject)(projectCard);
    }

    todayBtn.addEventListener('click', () => {
        const list = _components_dateCheck__WEBPACK_IMPORTED_MODULE_9__.dateCheck.filterTodayTasks()
        if(list.length == 0) {
