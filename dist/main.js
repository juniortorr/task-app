...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"projCard\">\r\n    <div class=\"profTitleBox\">\r\n            <h1 class=\"projTitle\">"
    + alias1(container.lambda((depth0 != null ? lookupProperty(depth0,"title") : depth0), depth0))
    + "</h1>\r\n            "
    + alias1(((helper = (helper = lookupProperty(helpers,"cardOptions") || (depth0 != null ? lookupProperty(depth0,"cardOptions") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"cardOptions","hash":{},"data":data,"loc":{"start":{"line":6,"column":12},"end":{"line":6,"column":27}}}) : helper)))
    + "\r\n    </div>\r\n\r\n    <ul class=\"taskList\">\r\n\r\n\r\n    </ul>\r\n</div>\r\n";
  ...
  return "\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"projectList") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":4},"end":{"line":14,"column":9}}})) != null ? stack1 : "");
},"useData":true});
...
/* harmony export */   callNewTask: () => (/* binding */ callNewTask),
...
const callNewTask = (taskArr) => {
    ...
    const newTask = new _components_task_js__WEBPACK_IMPORTED_MODULE_2__["default"](newTaskName)
...
class Project {
    constructor(title, priority) {
        ...
        ;(0,_domStuff__WEBPACK_IMPORTED_MODULE_2__.updateProjectListUI)(this.tasks)
    }
    speak(){
        console.log(this)
    }
    addTask() {
        (0,_app__WEBPACK_IMPORTED_MODULE_1__.callNewTask)(this.tasks)
    }
    removeTask() {
...
/* harmony import */ var _images_card_options_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./images/card-options.png */ "./src/images/card-options.png");
...
function newProjPopup() {
    ...
    btn.addEventListener('click', () => {;(0,_app__WEBPACK_IMPORTED_MODULE_2__.initiateNewProj)(input.value, select.value)})
...
// when we press add new task 
// it will need access to the project and array that this task belongs to
// push the task onto the array
// loop through the array and print it 

function updateProjectListUI() {
    const cardOptions = document.createElement('img');
    cardOptions.src = _images_card_options_png__WEBPACK_IMPORTED_MODULE_4__

    cardContainer.innerHTML = _views_partials_proj_card_handlebars__WEBPACK_IMPORTED_MODULE_1___default()({projectList: _components_data__WEBPACK_IMPORTED_MODULE_3__.projectList, cardOptionsIcon: _images_card_options_png__WEBPACK_IMPORTED_MODULE_4__})
    console.log('updated')
    // projectList.forEach((project) => {
    //     const div = document.createElement('div');
    //     const projTitleBox = document.createElement('div');
    ...
    //     projTitleBox.classList.add('projTitleBox')
    //     projTitle.textContent = project.title;
    //     taskList.append(newTaskBtn)
    //     projTitleBox.append(projTitle, cardOptions)
    //     div.append(projTitleBox, taskList)
